...
use App\Http\Controllers\MedicineActivity;
...
Route::group(['middleware' => ['common', 'auth', 'active']], function () {
    ...
    Route::resource('medicine_activity', MedicineActivity::class);
    Route::controller(MedicineActivity::class)->group(function () {
        Route::post('importmedicine_activity', 'importMedicine_activity')->name('medicine_activity.import');
        Route::post('medicine_activity/deletebyselection', 'deleteBySelection');
        Route::get('medicine_activity/lims_unit_search', 'limsUnitSearch')->name('medicine_activity.search');
    });


    Route::resource('payments', PaymentsModuleController::class);
    Route::resource('docter', DocterController::class);
    Route::controller(PaymentsModuleController::class)->group(function () {
        Route::post('importpayments', 'importMedicine_activity')->name('payments.import');
        Route::post('payments/deletebyselection', 'deleteBySelection');
        Route::get('payments/lims_unit_search', 'limsUnitSearch')->name('medicine_activity.search');
    });
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::get('sales/comlimentary', 'compilyCreate')->name('sale.compily');
          Route::post('sales/comlimentared', 'storeC')->name('sale.storec');
                 Route::get('sales/comliyList', 'compilyList')->name('sale.compilyList');
        Route::post('sales/deletebyselection', 'deleteBySelection');
              Route::post('sales/deletebycompily', 'deleteByCompliy');
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            ...
            Route::get('activity-report', 'activityReport');
            Route::get('activity-report-data', 'activityReportData')->name('report.activity-report');
            ...
            Route::post('legder_report_by_date', 'legderReportByDate')->name('report.legderByDate');
            Route::post('manufac_report_by_date', 'ManufReportByDate')->name('report.ManufByDate');
