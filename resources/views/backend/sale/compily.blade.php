                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>{{trans('Add complimentary')}}</h4>
                        </div>
                        <div class="card-body">
                            <p class="italic">
                                <small>{{trans('file.The field labels marked with * are required input fields')}}
                                    .</small></p>
                            {!! Form::open(['route' => 'sale.storec', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
...
@push('scripts')
    <script type="text/javascript">
     ...
     if (!isNaN(orderTaxValue)) {
    // If order_tax is a valid number, format and set the text content of the element with ID 'order_tax'
    $('#order_tax').text(orderTaxValue.toFixed({{ $general_setting->decimal }}));

    // Set the value of the input field with name 'order_tax'
    $('input[name="order_tax"]').val(orderTaxValue.toFixed({{ $general_setting->decimal }}));
}
