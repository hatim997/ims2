                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <!--    <div class="form-group">-->
                                        <!--        <label>Area</label>-->
                                        <!--        <input type="text" name="area" class="form-control date"-->
                                        <!--               placeholder="area"/>-->
                                        <!--    </div>-->
                                        <!--</div>-->
                                        <div class="col-md-4">
...
{{--                                                        class="form-control selectpicker" data-toggle="tooltip" title=""--}}
{{--                                                        data-original-title="Sale currency">--}}
{{--                                                    @foreach($currency_list as $currency_data)--}}
{{--                                                        <option value="{{$currency_data->id}}"--}}
{{--                                                                data-rate="{{$currency_data->exchange_rate}}">{{$currency_data->code}}</option>--}}
{{--                                                    @endforeach--}}
{{--                                                </select>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if($field->type == 'text')
                                                            <input type="text"
                                                                   ...
                                                                   class="form-control" @if($field->is_required)
                                                                {{'required'}}
                                                                @endif>
                                                        ...
                                                        @elseif($field->type == 'checkbox')
                                                            ...
                                                            @foreach($option_values as $value)
                                                                <label>
                                                                    <input type="checkbox"
                                                                           name="{{str_replace(' ', '_', strtolower($field->name))}}[]"
                                                                           value="{{$value}}" @if($value == $field->default_value)
                                                                        {{'checked'}}
                                                                        @endif @if($field->is_required)
                                                                        {{'required'}}
                                                                        @endif> {{$value}}
                                                                </label>
                                                                &nbsp;
                                                        ...
                                                        @elseif($field->type == 'select')
                                                            ...
                                                            <select class="form-control"
                                                                    name="{{str_replace(' ', '_', strtolower($field->name))}}" @if($field->is_required)
                                                                {{'required'}}
                                                                @endif>
                                                                @foreach($option_values as $value)
                                                                    <option
                                                        ...
                                                        @elseif($field->type == 'date_picker')
                                                            <input type="text"
                                                                   name="{{str_replace(' ', '_', strtolower($field->name))}}"
                                                                   value="{{$field->default_value}}"
                                                                   class="form-control date" @if($field->is_required)
                                                                {{'required'}}
                                                                @endif>
                                                        @endif
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <p id="change"
                                                       class="ml-2">{{number_format(0, $general_setting->decimal, '.', '')}}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
...
@push('scripts')
            ...
            $.get('getproduct/' + id, function (data) {
                ...
                $.each(product_code, function (index) {
                    if (is_embeded[index])
                        ...
                        lims_product_array.push(product_code[index] + ' (' + product_name[index] + ')!' + batch_no[index]);
                });
            });
            ...
            response: function (event, ui) {
                if (ui.content.length == 1) {
                  ...
                  console.log(data);
                    ...
                    console.log($('#lims_productcodeSearch').val() + '|' + 1);
                    console.log("data2");
                }
            },
    ...
    if (pre_qty > 0) {
        ...
        // Set product price based on conditions
    ...
    // Check for existing batch number before adding a new row
    var existingBatchNo = false;
    $("table.order-list tbody tr").each(function() {
        var currentBatchNo = $(this).find('.batch-no').val();
        if (currentBatchNo === data[16]) { // Compare with new batch number
            existingBatchNo = true; // Set flag if batch number exists
            return false; // Exit loop
        }
    });

    if (!existingBatchNo) { // Only add new row if batch number does not exist
        var newRow = $("<tr>");
        var cols = '';
        pos = product_code.indexOf(data[1]);
        ...
        if (data[12]) {
            cols += '<td><input type="text" class="form-control batch-no" value="' + data[16] + '" required/> <input type="hidden" class="product-batch-id" name="product_batch_id[]" value="' +  data[18] + '"/> </td>';
            cols += '<td class="expired-date">' + data[17] + '</td>';
        } else {
        ...
        cols += '<td class="discount">{{number_format(0, $general_setting->decimal, '.', '')}}</td>'; // Corrected line
        ...
        alert("This batch number already exists in the order list.");
    }
}
            });
        }
